...
rule fs_surf_to_gii:
    ...
    input: "sourcedata/fastsurfer/sub-{subject}/surf/{hemi}.{surf_suffix}"
    params:
    ...
    output: "sourcedata/gifti/sub-{subject}/surf/{hemi,(lh|rh)}.{surf_suffix,(pial|white|inflated|sphere.reg)}.surf.gii"
    shell:
...
rule resample_to_fs:
    ...
    input:
        pial = "sourcedata/gifti/sub-{subject}/surf/{hemi}.pial.surf.gii",
        white = "sourcedata/gifti/sub-{subject}/surf/{hemi}.white.surf.gii",
        inflated = "sourcedata/gifti/sub-{subject}/surf/{hemi}.inflated.surf.gii",
        subj_sphere = "sourcedata/gifti/sub-{subject}/surf/{hemi}.sphere.reg.surf.gii",
    ...
    params:
        method = "BARYCENTRIC"
    output:
        pial = f"sourcedata/gifti/sub-{{subject}}/surf/{{hemi,(lh|rh)}}.pial.{config['fs_den']}.surf.gii",
        white = f"sourcedata/gifti/sub-{{subject}}/surf/{{hemi,(lh|rh)}}.white.{config['fs_den']}.surf.gii",
        inflated = f"sourcedata/gifti/sub-{{subject}}/surf/{{hemi,(lh|rh)}}.inflated.{config['fs_den']}.surf.gii"
    group: "subj"
...
rule apply_tkr2scanner_surf:
    ...
    input: 
        surf = f"sourcedata/gifti/sub-{{subject}}/surf/{{hemi}}.{{surf_suffix}}.{config['fs_den']}.surf.gii",
        tkr2scanner = "sourcedata/fastsurfer/sub-{subject}/mri/transforms/tkr2scanner.xfm"
    output:
        surf = f"sourcedata/gifti/sub-{{subject}}/surf/{{hemi,(lh|rh)}}.{{surf_suffix,(pial|white|inflated)}}.Native{config['fs_den'][2:]}.surf.gii"
    container: config["singularity"]["workbench"]
    group: "subj"
    shell:
...
rule compute_cortical_thickness:
    ...
    input: 
        pial = f"sourcedata/gifti/sub-{{subject}}/surf/{{hemi}}.pial.Native{config['fs_den'][2:]}.surf.gii",
        white = f"sourcedata/gifti/sub-{{subject}}/surf/{{hemi}}.white.Native{config['fs_den'][2:]}.surf.gii"
    output:
        gii = f"sourcedata/gifti/sub-{{subject}}/metric/{{hemi}}.thickness.Native{config['fs_den'][2:]}.shape.gii"
    container: config['singularity']['workbench']
    group: 'subj' 
    shell:
...
rule gen_depth_surfaces:
    ...
    input:         
        ...
        white = f"sourcedata/gifti/sub-{{subject}}/surf/{{hemi}}.white.Native{config['fs_den'][2:]}.surf.gii",
    output:
        depth = f"sourcedata/gifti/sub-{{subject}}/surf/{{hemi,(lh|rh)}}.depth-{{depth}}.Native{config['fs_den'][2:]}.surf.gii"
    group: "subj"
    container: config["singularity"]["workbench"]
    shell:
...
rule sample_depth_surfaces:
    ...
    input:
        ...
        depth = f"sourcedata/gifti/sub-{{subject}}/surf/{{hemi}}.depth-{{depth}}.Native{config['fs_den'][2:]}.surf.gii",
    params:
        sample_method = "trilinear"
    output:
        depth = f"sourcedata/gifti/sub-{{subject}}/metric/{{hemi}}.depth-{{depth}}.T1w.Native{config['fs_den'][2:]}.shape.gii",
    container: config["singularity"]["workbench"]
    group: "subj"
    shell:
...
rule gii_surf_datasink:
    ...
    """
    input: f"sourcedata/gifti/sub-{{subject}}/surf/{{hemi}}.{{surf_suffix}}.Native{config['fs_den'][2:]}.surf.gii"
...
rule gii_thickness_datasink:
    ...
    """
    input: f"sourcedata/gifti/sub-{{subject}}/metric/{{hemi}}.thickness.Native{config['fs_den'][2:]}.shape.gii"
...
rule gii_depth_sample_datasink:
    ...
    """
    input: f"sourcedata/gifti/sub-{{subject}}/metric/{{hemi}}.depth-{{depth}}.T1w.Native{config['fs_den'][2:]}.shape.gii"
...
rule qc_surf:
    ...
    input:
        ...
        lh_pial = f"sourcedata/gifti/sub-{{subject}}/surf/lh.pial.Native{config['fs_den'][2:]}.surf.gii",
        lh_white = f"sourcedata/gifti/sub-{{subject}}/surf/lh.white.Native{config['fs_den'][2:]}.surf.gii",
        rh_pial = f"sourcedata/gifti/sub-{{subject}}/surf/rh.pial.Native{config['fs_den'][2:]}.surf.gii",
        rh_white = f"sourcedata/gifti/sub-{{subject}}/surf/rh.white.Native{config['fs_den'][2:]}.surf.gii",
        t1 = bids(root="sourcedata/preproc_t1", datatype="anat", **config["subj_wildcards"], suffix="T1w.nii.gz")
    params:
        workbench = config["singularity"]["workbench"]
    output: 
